...
const Data: DataType[] = [
  {
    ...
    description:
      "I spent the summer of my freshman year of high school learning how to code at pinecone academy where I learned how to code basic HTML, CSS and Javascript. This is where I started to make some of my small projects for fun after my classes.",
  },
  {
    date: "2024 - 2025",
    title: "Entering the HOP program and learning full stack development",
    description:
      "After the summer I spent at Pinecone summer academy, I was interested in learning more about coding and wanted to go more advanced. This is where I was introduced to ReactJS, NextJS, nodeJS, mongoDB and more tools on full stack developing over the course of my sophmore school year.",
  },
  {
    date: "Summer 2025",
    title: "Interning as a full stack developer at Pinecone",
    description:
      "After finishing my time in the HOP program, I applied and was offered a spot to intern at pinecone over the summer and worked in a team of 6 other interns to create a real estate website. Additionally, I worked in person in Mongolia as an assistant teacher for Pinecone academy and taught 30 students how to code HTML, CSS and Javascript.",
  },
  {
    date: "2025-2026",
    title: "Independent Full Stack Developer in Junior year of high school",
    description:
      "After finishing my internship at pinecone, I focused on school for most of the year and made occasional projects, such as a Lost and found website I made for my school FBLA competition. I also started to plan and design future projects that I am planning to work on in Mongolia.",
  },
];
